	 ...
	 * It should step through the linked list and make a copy of each term. The runtime of this method should be 𝑂(𝑛).
 	...
 	public SLinkedList<E> deepClone()
 	{
 		...
 		if(this.isEmpty()) {
 			...
 			SNode<E> current_node = this.head;
 			deepCopy.head = new SNode<>(this.head.element.deepClone());
 			SNode<E> temp = deepCopy.head;
 			
 			while(current_node.next != null){
 				temp.next = new SNode<>(current_node.next.element.deepClone());
 				temp = temp.next;
